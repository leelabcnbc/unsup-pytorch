...
--       table.insert(all_encoder_scale, module.encoder.modules[3].weight:view(1,32):clone()) 
    ...
    npy4th.savenpy('demo_psd_debug_beta5_data.npy', torch.cat(all_data,1))
    npy4th.savenpy('demo_psd_debug_beta5_weight.npy', torch.cat(all_weight,1))
    
    npy4th.savenpy('demo_psd_debug_beta5_encoder_weight.npy', torch.cat(all_encoder_weight,1))
    npy4th.savenpy('demo_psd_debug_beta5_encoder_bias.npy', torch.cat(all_encoder_bias,1))
--     npy4th.savenpy('demo_psd_debug_encoder_scale.npy', torch.cat(all_encoder_scale,1))
    
    npy4th.savenpy('demo_psd_debug_beta5_grad_weight.npy', torch.cat(all_grad_weight,1))
    npy4th.savenpy('demo_psd_debug_beta5_serr.npy', torch.FloatTensor(all_serr))
end
