...
function train(module,dataset)
  ...
  for t = 1,params.maxiter do
    ...
    npy4th.savenpy('demo_fista_conv_debug_data.npy', torch.cat(all_data,1))
    npy4th.savenpy('demo_fista_conv_debug_weight.npy', torch.cat(all_weight,1))
    npy4th.savenpy('demo_fista_conv_debug_grad_weight.npy', torch.cat(all_grad_weight,1))
    npy4th.savenpy('demo_fista_conv_debug_serr.npy', torch.FloatTensor(all_serr))
end
